...
--Following are some snowpipe command whcih will help you to check snowpipi ststus
select SYSTEM$PIPE_STATUS('RETAIL_SNOWPIPE_TRANSACTION');
select * from table(information_schema.copy_history(table_name=>'RETAIL_SNOWPIPE_TRANSACTION',
